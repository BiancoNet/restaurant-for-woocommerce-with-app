<?php
/**
 * It is the content grid 1 shortcode template.
 *
...
?>
<figure class="wrstyle-1 tppost-<?php the_ID(); ?>">

	<div class="wrstyle-1-image">
	...
	?>
		...
		woo_restaurant_booking_button_html( 1, $hide_atc );
		?>
	</figcaption>
</figure>
