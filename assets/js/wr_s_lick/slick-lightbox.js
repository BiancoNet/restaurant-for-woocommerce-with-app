/**
 * It is the slick lightbox script asset.
 *
...
(function ($) {
		...
		SlickLightbox.prototype.initSlick             = function (index) {
			...
			if (this.options.slick != null) {
				if (typeof this.options.slick === 'function') {
					...
					this.slick = this.$modalElement.find( '.slick-lightbox-slick' ).wr_wr_s_lick( $.extend( {}, this.options.slick, additional ) );
				}
			} else {
	...
	$.fn.unslickLightbox = function () {
		/* Removes everything. */
		return $( this ).trigger( 'destroy.slickLightbox' ).each(
			function () {
