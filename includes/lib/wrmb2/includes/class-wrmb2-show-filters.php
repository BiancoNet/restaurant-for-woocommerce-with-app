...
/**
 * Show On Filters
 * Use the 'wrmb2_show_on' filter to further refine the conditions
...
class WRMB2_Show_Filters {
	 ...
	 * @param  array $meta_box_args Metabox config array.
	 * @param  WRMB2 $wrmb           The WRMB2 instance.
	 * @return bool                 Whether to display this metabox on the current page.
	 */
	public static function check_id( $display, $meta_box_args, $wrmb ) {
		...
		$object_id = is_admin() ? $wrmb->object_id() : get_the_ID();
	 ...
	 * @param  bool  $display       To display or not.
	 * @param  array $meta_box_args Metabox config array.
	 * @param  WRMB2 $wrmb           WRMB2 object.
	 * @return bool            Whether to display this metabox on the current page.
	 */
	public static function check_page_template( $display, $meta_box_args, $wrmb ) {
		...
		$object_id = $wrmb->object_id();

		if ( ! $object_id || 'post' !== $wrmb->object_type() ) {
			return false;
		}
