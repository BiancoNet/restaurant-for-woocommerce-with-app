<?php
/**
 * It is the multi base field type.
 *
 * @package woorestaurant
 */

/**
 * WRMB Multi base field type
 *
 * @since  2.2.2
 *
 ...
 * @link      https://wrmb2.io
 */
abstract class WRMB2_Type_Multi_Base extends WRMB2_Type_Base {
	...
	public function concat_items( $args = array() ) {
		...
		$value = WRMB2_Utils::normalize_if_numeric( $value );
		...
		foreach ( $options as $opt_value => $opt_label ) {
			...
			if ( WRMB2_Utils::normalize_if_numeric( $opt_value ) === $value ) {
				$a['checked'] = 'checked';
			}
