...
class WRMB2_Utils {
	 ...
	 * @return string URL to WRMB2 resources
	 */
	public static function url( $path = '' ) {
		...
		$wrmb2_url = self::get_url_from_dir( wrmb2_dir() );

		/**
		 * Filter the WRMB location url.
		 *
		 * @param string $wrmb2_url Currently registered url.
		 */
		self::$url = trailingslashit( apply_filters( 'wrmb2_meta_box_url', $wrmb2_url, WRMB2_VERSION ) );
	...
	/**
	 * Helper function for WRMB_Utils::php_to_js_dateformat().
	 *
	 * @since  2.2.0
