<?php
/**
 * This is the WP REST Controller file.
 *
 * @package woorestaurant
 */

/**
 * It is the WP_REST_Controller.
 */
abstract class WP_REST_Controller {
	...
	public function register_routes() {
		...
		_doing_it_wrong( 'WP_REST_Controller::register_routes', sprintf( esc_attr__( "Method '%s' must be overridden." ), __METHOD__ ), '4.7' );
	}
	...
	public function get_items_permissions_check( $request ) {
		return new WP_Error(
			'invalid-method',
			/* translators: %s is replaced with the method */
	 ...
	 *
	 * @param array  $data it is the data variable.
	 * @param string $context It is the context.
	 * @return array
	 */
	 ...
	 *
	 * @param array           $object It is the object.
	 * @param WP_REST_Request $request It is the Request.
	 ...
	 *
	 * @param array           $object It is the object variable.
	 * @param WP_REST_Request $request It is the request.
	 */
